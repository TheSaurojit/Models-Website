    ...
    <div class="flex flex-col md:flex-row gap-6 md:gap-20">
      <div class="bg-[#F4F4F4] w-full md:w-[780px] xl:w-[880px] 2xl:w-[980px] h-64 relative overflow-hidden">
        <div class="flex flex-col md:flex-row h-full">
          <div class="text-sm p-3 flex-1 flex items-center">
            <p class="text-center md:text-left">Gian Paolo Barbieri Passes, Paris Show Calendars Are Out, and more news you missed</p>
          </div>
          <div class="flex-shrink-0 m-3 w-full md:w-auto">
            <img src="/imagess/image-1.png" alt="Model" class="w-full h-48 md:h-full object-cover">
          </div>
        </div>
      </div>
      ...
      <div class="bg-[#F4F4F4] h-auto md:h-[480px] w-full md:w-96 xl:w-[484px] 2xl:w-[530px] relative overflow-hidden">
        <div class="m-3">
          <img src="/imagess/image-2.png" alt="Model" class="w-full object-cover">
          <div class="text-sm mt-4 p-3 flex items-center text-center">
            <p>Gian Paolo Barbieri Passes, Paris Show Calendars Are Out, and more news you missed</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="bg-[#F4F4F4] w-full md:w-96 2xl:w-[484px] relative overflow-hidden">
        <div class="m-3">
          <div class="text-sm p-3 flex items-center text-center">
            <p>Alex Consani Wins Model of The Year at '24 Fashion Awards, Dior Headed to Rome for Cruise, and more news you missed</p>
          </div>
          <div class="mt-4">
            <img src="/imagess/image-3.png" alt="Model" class="w-full object-cover">
          </div>
        </div>
      </div>
      ...
      <div class="bg-[#F4F4F4] w-full md:w-96 2xl:w-[484px] h-auto md:h-52 relative overflow-hidden">
        <div class="flex flex-col md:flex-row gap-4">
          <div class="w-full md:w-1/2">
            <img src="/imagess/image.png" alt="Model" class="w-full h-48 md:h-64 object-cover">
          </div>
    ...
    </div><?php /**PATH C:\Users\DESKTOP\Desktop\Models Laravel\resources\views/components/component3.blade.php ENDPATH**/ ?>