...
<head>
    ...
    <title><?php echo e(Str::title($post->title)); ?></title>
    ...
    <link rel="stylesheet" id="grazia-icon-homepage-css" href="/css/icon-homepage.css" type="text/css"
        media="all">
    <link rel="stylesheet" id="grazia-editor-css-css" href="/css/editor.css" type="text/css" media="all">
    <link rel="stylesheet" id="elasticpress-facets-css" href="/css/facets-styles.css" type="text/css"
        media="all">
    ...
    <link rel="shortlink" href="https://graziamagazine.com/?p=264080">
    <link rel="alternate" type="application/json+oembed"
        href="https://graziamagazine.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgraziamagazine.com%2Farticles%2Flouis-vuitton-takashi-murakami-relaunch%2F">
    <link rel="alternate" type="text/xml+oembed"
        href="https://graziamagazine.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgraziamagazine.com%2Farticles%2Flouis-vuitton-takashi-murakami-relaunch%2F&format=xml">
    ...
    <script type="text/javascript">
        ...
        var chartbeat_author = 'Pema Bakshi';
        var chartbeat_section =
            'Louis Vuitton, Takashi Murakami, Louis Vuitton X Takashi Murakami, fashion, Fashion news, designer collaborations';
        (function() {
            /** CONFIGURATION START **/
...
<body class="articles-template-default single single-articles postid-264080 single-format-standard pushdown-ads">
    ...
    <div id="wrapper">
        ...
        <a href="#" class="nav-opener mobile-fixed-menu" data-once="cd963b9abe"><span>opener</span></a>
        <main id="main">
            <div class="article-outer" id="1" data-nonce="edc8f78e23" data-page-number=""
                data-page-category="">
                <div class="a-detail-wrap active" data-current-post="264080"
                    data-url="https://graziamagazine.com/articles/louis-vuitton-takashi-murakami-relaunch/"
                    data-offset="0">
                    <section class="heading-block heading-block-264080">
                        <div class="container">
                            <div class="category-list">
                                <ul>
                                    <li><a href="/category/<?php echo e($categoryName); ?>"><?php echo e($categoryName); ?></a></li>
                            ...
                            <div class="author-block">
                                <div class="img-wrap">
                                    <img alt="" src="<?php echo e($post->author->image); ?>"
                                        class="avatar avatar-150 photo" height="150" width="150"
                                        decoding="async">
                                </div>
                                <span class="auth">By <?php echo e(Str::title($post->author->name)); ?></span>
                            </div>
                    ...
                    <section class="articles-block news-detail-block" data-post-id="264080"
                        data-url="<?php echo e($url); ?>"
                        data-title="Louis Vuitton Relaunches Iconic Takashi Murakami Collaboration">
                        <div class="container">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <div class="related-articles">
                                                            <div class="article-lists">
                                                                ...
                                                                <?php $__currentLoopData = $relatedPosts->slice(0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php

                                                                        $rpUrl = route('blog', ['slug' => $post->slug]);

                                                                    ?>

                                                                    <div class="article-item">
                                                                        <div class="img-wrap">
                                                                            <a href="<?php echo e($rpUrl); ?>">
                                                ...
                                                <aside class="sidebar">
                                                    <div class="manual_spacer">
                                                        <div class="item float use_manual">
                                                            <div id="grazia_sidebar-0" class="dfp-ads center main-ad"
                                                                data-is-ad="true"></div>
                                                        </div>
                                                    </div>
                                                </aside>
                                            </div>
                                            <div id="grazia_page_breaker-0" class="dfp-ads center main-ad"
                                                data-is-ad="true"></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="theme-grazia" style="display: block">

                        <section class="home-video-wrapper">
                            <div class="video-wrap hero-image">
                                <div id="jwplayer_homepage_main_video_div">
                                    <script type="text/javascript">
                                        window.addEventListener('load', function() {
                                            grazia_jwplayer_embed("jwplayer_homepage_main_video_div",
                                                "<?php echo e(url('/videos/video1.mp4')); ?>",
                                                "");
                                        });
                                    </script>
                                </div>
                            ...
                            <div class="video-container">
                                ...
                                <button id="custom_mute" class="control-mute">
                                    <span class="icon-volume-mute2 control-position"></span>
                                </button>
                            </div>
                        </section>
                    </div>

                    <div class="promo-first-load" bis_skin_checked="1">


                        <div class="promo-full-width" bis_skin_checked="1">
                           
                            <div class="container" bis_skin_checked="1">
                                <div class="promo-desc" bis_skin_checked="1">
                                    <strong class="h3"><a href="#"
                                            data-title-reporting="Cruise Fashion TO">DISCOVER</a></strong>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="2" bis_skin_checked="1">
                <div class="a-detail-wrap active" data-current-post="264080"
                    data-url="" data-offset="7" bis_skin_checked="1">
                    <div class="listing-container" bis_skin_checked="1">
                        <div class="container" bis_skin_checked="1">
                            <div class="news-articles container-withsidebar" bis_skin_checked="1">
                                <div class="main-content " bis_skin_checked="1">
                                    <div class="articles-list" bis_skin_checked="1">

                                        <?php $__currentLoopData = $relatedPosts->slice(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="listing-item" bis_skin_checked="1">
                                            <div class="img-wrap " bis_skin_checked="1">
                                                <a href="<?php echo e($rpUrl); ?>"
                                                    style="background-image:url('<?php echo e($post->thumbnail); ?>');
    ...
    <script type="text/javascript" id="grazia-main-js-extra">
        ...
        var graziaDfpAdsData = {
            ...
            "targetingData": {
                "contentTitle": "Twenty Years Later, Louis Vuitton Celebrates Its Iconic Takashi Murakami Collaboration With A Re-Launch",
                "safetyKeywords": "",
                "author": "Pema Bakshi",
                "metaKeywords": "",
                "contentType": "Articles",
                "contentSite": "graziamagazine.com",
                "category": ["News Feed", "Fashion"],
                "customAdString": "",
                "postID": 264080,
                "userRoles": [],
                "primarycat": "fashion"
        ...
        var gaPromoTilesData = {
            ...
            "page_title": "Twenty Years Later, Louis Vuitton Celebrates Its Iconic Takashi Murakami Collaboration With A Re-Launch"
        };
        var grazia_object = {
...
Object Caching 265/405 objects using Memcached
Database Caching 1/25 queries in 0.022 seconds using Memcached

Served from: graziamagazine.reworldmediafactory.com @ 2025-01-03 13:10:24 by W3 Total Cache
-->
<?php /**PATH C:\Users\DESKTOP\Desktop\Grazia laravel blog\resources\views/pages/blog.blade.php ENDPATH**/ ?>