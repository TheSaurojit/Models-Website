...
<body>
        ...
        <div class="main-content app-content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div align="center">
                        <center>
                            <h1 style="position: absolute; left: 40%;font-size: 50px;top: 40%;">WELCOME TO <br><b
                                    style="color: rgb(132 91 221)!important;">ADMIN PANEL</b></h1>
                        </center>
                    </div>
                </div>
            </div>
    ...
    <!-- JSVECTOR MAPS JS -->
    <script src="/admin/build/assets/libs/jsvectormap/js/jsvectormap.min.js"></script>
    <script src="/admin/build/assets/libs/jsvectormap/maps/world-merc.js"></script>

    <!-- APEX CHARTS JS -->
    <script src="/admin/build/assets/libs/apexcharts/apexcharts.min.js"></script>

    <!-- CHARTJS CHART JS -->
    <script src="/admin/build/assets/libs/chart.js/chart.min.js"></script>

    <!-- CRM-Dashboard -->
    <link rel="modulepreload" href="/admin/build/assets/crm-dashboard-5975eef2.js" />
    <script type="module" src="/admin/build/assets/crm-dashboard-5975eef2.js"></script>
...
<?php /**PATH C:\Users\DESKTOP\Desktop\Grazia laravel blog\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>