...
<?php $component = App\View\Components\Admin\ImageComponent::resolve(['name' => 'image','value' => ''.e($celebrity['image']).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
