                                    ...
                                    <div class="row gy-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="input" name="title"
                                                ...
                                                value="<?php echo e(isset($post) ? $post->title : old('title')); ?>" />
                                        ...
                                        <div>
                                            ...
                                            <select name="category" id="headline" class="form-control">
                                                ...
                                                <option value="<?php echo e($cat->id); ?>"  <?php echo e($post->category_id == $cat->id ? "selected" : ''); ?>> <?php echo e($cat->category); ?></option>
                                        ...
                                        <div>
                                            ...
                                            <select name="trending" id="headline" class="form-control">
                                                ...
                                                <option value="false" <?php echo e(isset($post) && $post->trending == 0 ? 'selected' : ''); ?>>No</option>
                                                <option value="true" <?php echo e(isset($post) && $post->trending == 1 ? 'selected' : ''); ?>>Yes</option>
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="input"
                                                ...
                                                value="<?php echo e(isset($post) ? $post->description : old('description')); ?>" />
                                            ...
                                            <div class="">
                                                ...
                                                <input type="text" class="form-control" id="input"
                                                    ...
                                                    value="<?php echo e(isset($post) ? $post->keywords : old('keywords')); ?>" />
                                            ...
                                            <div>
                                                ...
                                                <img src="<?php echo e(isset($post) ? $post->thumbnail : ""); ?>" alt="Image Not Found"
                                            ...
                                            <div class="">
                                                ...
                                                <input type="text" class="form-control" id="input"
                                                    ...
                                                    value="<?php echo e(isset($post) ? $post?->image_caption : old('image_caption')); ?>" />
                                            ...
                                            <div>
                                                ...
                                                <select name="author" id="headline" class="form-control">
                                                    ...
                                                    <?php $__currentLoopData = $allAuthor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    
                                                    <option value="<?php echo e($author->id); ?>" <?php echo e(isset($post) && $post->author_id == $author->id ? "selected" : ''); ?> > <?php echo e($author->name); ?></option>
                                        ...
                                        <div>
                                            ...
                                            <textarea name="blog" id="editor" cols="30" rows="20">
                                                    <?php echo e(isset($post) ? $post->blog : old('blog')); ?>
...
<?php /**PATH C:\Users\DESKTOP\Desktop\FHM laravel blog\resources\views/admin/editor.blade.php ENDPATH**/ ?>