...
<?php $component = App\View\Components\Admin\Table::resolve(['headers' => ['Name' ,'Image'],'columns' => ['name'],'arrayData' => $celebrities,'editUrl' => 'update-celebrity','deleteUrl' => 'delete-celebrity'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/orcas/Desktop/Projects/Models-Website/resources/views/admin/celebrity/all-celebrity.blade.php ENDPATH**/ ?>