...
<head>
    ...
    <title>GRAZIA Japan Homepage - Grazia</title>
    ...
    <link rel="alternate" type="application/json" href="https://graziamagazine.com/wp-json/wp/v2/pages/2">
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://graziamagazine.com/xmlrpc.php?rsd">
    <meta name="generator" content="WordPress 6.4.1">
    <link rel="shortlink" href="https://graziamagazine.com/">
    <link rel="alternate" type="application/json+oembed"
        href="https://graziamagazine.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgraziamagazine.com%2F">
    <link rel="alternate" type="text/xml+oembed"
        href="https://graziamagazine.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgraziamagazine.com%2F&format=xml">
...
<body
    class="home page-template page-template-page-templates page-template-template-homepage-v2 page-template-page-templatestemplate-homepage-v2-php page page-id-2 pushdown-ads">
    ...
    <div id="wrapper">
        ...
        <a href="#" class="nav-opener mobile-fixed-menu" data-once="5307eeaf65"><span>opener</span></a>
        <main id="main">

            <section class="two-cols-container column-block">
                <div class="two-cols one">

                    <?php $__currentLoopData = $recentPosts->slice(0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="item">
                            <div class="img-wrap">
                                <a href="<?php echo e($url); ?>"
                                    style="background-image:url('<?php echo e($post->thumbnail); ?>');"></a>
                            </div>
                            <div class="text">
            ...
            <?php $__currentLoopData = $recentPosts->slice(7, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <section class="home-banner">
                    <a href="<?php echo e($url); ?>" style="background-image:url('<?php echo e($post->thumbnail); ?>');">
                        <div class="home-logo">
                            <img width="4933" height="1526" src="/images/grazia-int.png"
            ...
            <section class="tiles-wrapper">
                <div class="large-tile">
                    <?php $__currentLoopData = $recentPosts->slice(2, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="tiles-item">
                            <a href="<?php echo e($url); ?>">
                                <img width="1024" height="576" src="<?php echo e($post->thumbnail); ?>"
                ...
                <div class="small-tile">
                    ...
                    <?php $__currentLoopData = $recentPosts->slice(3, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="tiles-item">
                            <a href="<?php echo e($url); ?>">
                                <img width="400" height="225" src="<?php echo e($post->thumbnail); ?>"
                                    class="attachment-grazia-small-tile size-grazia-small-tile" alt=""
                                    decoding="async"
                                    style="
                                object-position : top ;
                                object-fit : cover ;
            ...
            <section id="grazia-subscribe-form" class="subscribe-form-wrapper">
                <div class="image-wrapper">
                    <img width="400" height="267" src="/images/subscribe_grazia.jpg"
                        class="attachment-grazia-small-tile size-grazia-small-tile" alt="" decoding="async">
                </div>
                <div class="footer-form subscription-form">
                    <strong class="subscribe">Subscribe to our newsletter</strong>
                    <p>for special offers, notifications and new releases:</p>
                    ...
                    <div id="mc_embed_signup">
                        <form action="#" onsubmit="openModal()" method="post" id="mc-embedded-subscribe-form"
                            name="mc-embedded-subscribe-form" class="validate footer-mailchimp" target="_blank"
                            novalidate="">
                            <div id="mc_embed_signup_scroll">
                                <h2>Subscribe to our mailing list</h2>
                                <div class="mc-field-group">
                                    <label for="mce-EMAIL">Enter your email for the latest offers </label>
                                    <input type="email" value="" name="EMAIL" class="required email"
                                        id="modal-email" placeholder="E-mail address" required>
                                </div>
                                ...
                                <div style="position: absolute; left: -5000px;" aria-hidden="true">
                                    <input type="hidden" id="nonce_field" name="nonce_field"
                                        value="220a88ae22"><input type="hidden" name="_wp_http_referer"
                                        value="/"> <input type="hidden" name="place" value="footer">
                                    <input type="text" name="b_526e9924188fe27f38c6e3217_1d647da36e"
                                        tabindex="-1" value="">
                                </div>
                                <div class="clear">
...
Object Caching 386/481 objects using Memcached
Database Caching 3/17 queries in 0.009 seconds using Memcached

Served from: graziamagazine.reworldmediafactory.com @ 2025-01-01 02:40:00 by W3 Total Cache
-->
<?php /**PATH C:\Users\DESKTOP\Desktop\Grazia laravel blog\resources\views/pages/index.blade.php ENDPATH**/ ?>