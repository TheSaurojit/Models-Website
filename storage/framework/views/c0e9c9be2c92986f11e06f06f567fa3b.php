        ...
        <div class="w-100">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('create-category')); ?>" method="POST">
...
<?php $component = App\View\Components\Admin\InputField::resolve(['type' => 'text','name' => 'category'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DESKTOP\Desktop\Models Laravel\resources\views/admin/category/create-category.blade.php ENDPATH**/ ?>