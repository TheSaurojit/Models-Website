...
<head>
    ...
    .popup {
        ...
        border: 2px solid rgb(230, 140, 140);
        padding: 50px;
        width: 400px;
        height: 200px;
        z-index: 1000;
        ...
        <div class="main-content app-content">
                                    ...
                                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo e($cat->headline ? "Yes" : "No"); ?> </td>
                                               
                                                <td style="">
                                                        <a href="<?php echo e(route('update-category',['id'=> $cat->id])); ?>"
                                                            style="
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        "
                                                        onclick="confirmDelete( <?php echo e($cat->id); ?>)">
                                                    Delete
                                                </a>                                                                                       
                                                </td>
                                            </tr>
         ...
         <div id="confirmation-popup" class="popup">
            <div class="popup-content">
                <strong>All articles related to this category will be deleted?</strong><br>
                <button onclick="deleteItem()" style="background-color: red; padding: 10px 20px; border: 0">Yes</button>
                <button onclick="closePopup()" style="background-color: green;  padding: 10px 20px ;  border: 0">No</button>
            </div>
        </div>
...
function deleteItem() {
    if (deleteId !== null) {
    return    location.href=`/auth/delete-category/${deleteId}`;
    }
}
    ...
    <link rel="modulepreload" href="/admin/build/assets/datatables-52162115.js" />
    <script type="module" src="/admin/build/assets/datatables-52162115.js"></script>
...
<?php /**PATH C:\Users\DESKTOP\Desktop\Grazia laravel blog\resources\views/admin/all_category.blade.php ENDPATH**/ ?>