        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row gap-8 mt-4">
                <div class="block md:hidden mt-14">
                    <div class="flex">
                        <h1 class="text-2xl whitespace-nowrap text-[#C3C3C3] mt-6">Aria Forsa</h1>
                ...
                <div class="md:mt-20 w-full">
                    <div class="hidden md:block">
                        <h1 class="text-4xl whitespace-nowrap text-[#C3C3C3] text-center">Aria Forsa</h1>
                    </div>
                            ...
                            <div class="swiper mobile-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide flex flex-col items-start">
                                        <img src="/imagess/Profile Image-1.png" class="w-72 h-36">  
                                        <h2 class="text-xs font-semibold mt-4">Darlene Robertson</h2>
                                    </div>
                                    <div class="swiper-slide flex flex-col items-start">
                                        <img src="/imagess/Profile Image-2.png" class="w-72 h-36">  
                                        <h2 class="text-xs font-semibold mt-4">Darlene Robertson</h2>
                                    </div>
                                    <div class="swiper-slide flex flex-col items-start">
                                        <img src="/imagess/Profile Image-3.png" class="w-72 h-36">  
                                        <h2 class="text-xs font-semibold mt-4">Darlene Robertson</h2>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-5 max-w-md mx-auto md:mx-0">
                        ...
                        <p class="text-[#696A6E] text-lg md:text-left md:px-0">
                            Insider HackZ is an online resource that serves as a comprehensive guide for penetration testers, security researchers, and ethical hackers. It is part of the HackTricks platform.
                        </p>
                    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide flex flex-col items-start">
                        <div class="flex bg-[#F4F4F4] text-left gap-4">
                            <img src="/imagess/Profile Image-1.png" class="w-72 h-72">  
                            <h2 class="text-sm font-semibold mt-24">Phillip Lim Steps Down, Peter Do Exits Helmut Lang, and more news you missed</h2>
                        </div>
                    </div>
...
</html><?php /**PATH C:\Users\DESKTOP\Desktop\Models Laravel\resources\views/pages/profile.blade.php ENDPATH**/ ?>