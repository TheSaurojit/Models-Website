                        ...
                        <div class="card custom-card">
                            ...
                            <form method="POST"  novalidate>
                                <div class="card-body">
                                    <div class="row gy-4">
                                        <div>
                                            <p class=" "><b> Category Name : </b></p>

                                            <input type="text" class="form-control" id="input" name="category"
                                                required placeholder=" category name"
                                                value="<?php echo e(isset($category) ? $category->category : old('title')); ?>" />

                                        </div>

                                        <div class="">

                                            <p class="mb-2 "><b> Headline : </b></p>
                                            <select name="headline" id="headline" class="form-control">
                                                <option value="false" <?php echo e(isset($category) && $category->headline ? "selected" : ''); ?>>No</option>
                                                <option value="true" <?php echo e(isset($category) && $category->headline ? "selected" : ''); ?>>Yes</option>
                                              </select>
                                        </div>
...
<?php /**PATH C:\Users\DESKTOP\Desktop\Grazia laravel blog\resources\views/admin/create-category.blade.php ENDPATH**/ ?>