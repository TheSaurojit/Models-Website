                                    ...
                                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo e($post->category->category); ?> </td>
                                                <td> <?php echo e($post->trending ? "Yes" : "No"); ?> </td>
                                                <td> <?php echo e(Str::limit($post->title, 15, '...')); ?></td>
                                                <td> <img src=" <?php echo e($post->thumbnail); ?> " alt="Not Found" width="100px" ></td>
                                                <td><a href="<?php echo e(route('first_post',['id'=>$post->id])); ?>"  
                                                    style="
                                                  ...
                                                  <td><a href="<?php echo e(route('second_post',['id'=>$post->id])); ?>"  
                                                    style="
                                                    background: rgb(90, 99, 223) ;
                                                    text-decoration:none;
                                                    padding: 10px;
                                                    padding-left: 20px;
                                                    padding-right: 20px;">Make second post</a></td>
                                               
                                                <td style="">
                                                        <a href="<?php echo e(route('update-post',['id'=> $post->id])); ?>"
                                                            style="
                                                    ...
                                                    <a href="<?php echo e(route('delete-post',['id'=> $post->id])); ?>"
                                                        style="
                                                            background: rgb(249, 1, 51);
                                                            padding: 10px;
                                                            padding-left: 20px;
                                                            padding-right: 20px;
                                                            margin-left : 10px;
...
<?php /**PATH C:\Users\DESKTOP\Desktop\Grazia laravel blog\resources\views/admin/all_posts.blade.php ENDPATH**/ ?>